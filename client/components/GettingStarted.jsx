  ...
  return (
    <div className="component">
      ...
      <p className="pcomp">
        ...
        current working directory. Config and migration directory/files will be created here. To start the project, type <p className="pcomp"><b> deno run --unstable --allow-read --allow-write --allow-net cli.ts init</b></p> This will create a <b>setup.ts</b> file we will use to configure our mongoDB connection.
      </p>
      ...
      <p className="pcomp">
        ...
        changes. We'll talk more about how we can interact with MongoDB but first let's look at an example migration with two two migration files below.
      </p>
      <h4>Example Migration</h4>
      <p className="pcomp">
      2021_01_01_24_12_60_testmigration1.ts
        </p>

          <img src={migration1} />

          <p className="pcomp">
      2021_01_02_24_12_60_testmigration2.ts
        </p>
      ...
      <p className="pcomp">
        ...
        <p className="pcomp">
        In <b>testmigration1</b> fwd has been defined to find all documents with "item : 'boba'" within the food collection, and add a 'price' field with a value of 25.
        </p>

        <p className="pcomp">
        In <b>testmigration2</b>, fwd is defined to add a quantity field to all documents with "type : 'doodads'" in the widget collection. Because <b>testmigration1</b> was created first, that will be the first migration run.
        </p>

         We can choose to run just this migration (fwd), or all migrations (full). Let's go ahead and run all of them. <p className="pcomp"><b> deno run --unstable --allow-read --allow-write --allow-net cli.ts full</b></p>

Great! Now all the migrations have been applied.
        ...
        quanitity key from all instances of boba within the food collection.<br/>
      ...
      <p className="pcomp">
        ...
        official Mongodb support for Deno), which allows code in the migration
        files to interact with MongoDB and perform CRUD operations. If you want to access another database without changing the database in the setup file you can use the client object in the argument.The two arguments passed in to each function (client,db) let you
      ...
      <p className="pcomp">
        ...
        insufficient, you can instead access the <a target='_blank' className='url' href="https://docs.mongodb.com/manual/reference/command/">MongoDB database commands</a> using client.runCommand('databaseName',databaseCommand). Several
